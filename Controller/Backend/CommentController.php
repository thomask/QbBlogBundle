...
class CommentController extends ContainerAware
{
    ...
    public function indexAction()
    {
        ...
        return $this->container->get('templating')->renderResponse(
            'QbBlogBundle:Backend/Comment:index.html.'.$this->container->getParameter('qb_blog.template.engine'),
            array(
                'comments' => $comments,
            )
        );
    ...
    public function editAction($id)
    {
        ...
        return $this->container->get('templating')->renderResponse(
            'QbBlogBundle:Backend/Comment:edit.html.'.$this->container->getParameter('qb_blog.template.engine'),
            array(
                'comment' => $comment,
